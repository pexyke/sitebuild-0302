...
const formatCardData = (book, index) => {
    return `<div class="card-container">                
    <div class="card-content">
        <div class="card-number-container">${index}</div>
        <div class="card-data">
            <div class="sub">
                ${book.sub}
            </div>
...
const insertBooks = () => {
    const cardContainer = document.getElementById("bestSellers");
    data.map((book, index) => cardContainer.insertAdjacentHTML("beforeend", formatCardData(book, index+1)));
}

window.addEventListener("load", insertBooks);